...
export const Navbar = () => {
  ...
  return (
    <>
      <div className="bg-black/3 backdrop-blur-sm  border-b border-zinc-800 py-2.5 px-3 sm:px-10 flex justify-between items-center fixed max-w-screen min-w-screen top-0 z-50">
