  ...
  return (
    <div className="border border-zinc-800 py-2.5 px-3 sm:px-10 flex justify-between items-center fixed max-w-screen min-w-screen top-0 z-50">
      ...
      <div className={`flex  items-center relative px-12`}>
        ...
        <div className={`${tap ? '-space-y-6' : '-space-y-3'} absolute right-0 cursor-pointer transition-all duration-300 p-1 flex flex-col justify-center overl`} onClick={() => setTap(pre => !pre)}>
